...
<div class="max-wide">
  <div class="formSelect">
    <label>
      後援会入会
      <input type="radio" name="select" value="#form01" checked class="formSelect">
      <span class="formSelect_radio"></span>
    </label>

    <label>
      お問い合わせ
      <input type="radio" name="select" value="#form02" class="formSelect">
      <span class="formSelect_radio"></span>
    </label>
  </div>
  <div class="formUnit">
    <div id="form01">
      ...
      <dl class="formList">
        <div class="formList_item">
          ...
          <dd class="formList_dd"><input type="text" class="el_input"></dd>
        </div>
        <div class="formList_item">
        ...
        <div class="formList_item">
          ...
          <dd class="formList_dd">
            <input type="text" class="el_input el_input__223" name="zip" id="postalCode01">
            <small>
              ハイフン無しでご入力ください。<br>
        ...
        <div class="formList_item">
          ...
          <dd class="formList_dd"><input type="text" class="el_input" name="address01"></dd>
        </div>
        <div class="formList_item">
        ...
        <div class="formList_item">
          ...
          <dd class="formList_dd"><input type="email" class="el_input"></dd>
        </div>
        ...
        <div class="formList_item formList_item__mb">
          ...
          <dd class="formList_dd">
            <input type="text" class="el_input el_input__date">
            年
            <input type="text" class="el_input el_input__date">
            月
            <input type="text" class="el_input el_input__date">
      ...
      <div class="btnWrapper">
        <input type="submit" class="formSend" value="確認画面へ >">
      </div>
    </div>
    ...
    <div id="form02">
      ...
      <dl class="formList">
        ...
        <div class="formList_item formList_item__txt">
          <dt class="formList_dt require">住お問い合わせ内容</dt>
          <dd class="formList_dd">
            <textarea class="formTxtarea"></textarea>
          </dd>
        </div>
